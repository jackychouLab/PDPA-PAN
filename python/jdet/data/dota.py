...
class DOTADataset(CustomDataset):
    ...
    def evaluate(self, results, work_dir, epoch, logger=None, save=True):
        ...
        for i, classname in tqdm(enumerate(self.CLASSES), total=len(self.CLASSES)):
            ...
            rec, prec, ap, F1 = voc_eval_dota(c_dets, classname_gts, iou_func=iou_poly)
...
def test_eval():
    ...
    results = jt.load("/home/jackychou/base_project/JDet-master/work_dirs/s2anet/detections/val_1/val.pkl")
    # results = results
    dataset = DOTADataset(annotations_file='/home/jackychou/base_project/JDet-master/datasets/2048_DOTA/train_2048_512_1.0/labels.pkl',
        images_dir='/home/jackychou/base_project/JDet-master/datasets/2048_DOTA/train_2048_512_1.0/images')
