...
RS2022_CLASSES = ['Airplane', 'Vehicle', 'Intersection', 'Ship', 'Bridge', 'Tennis_Court', 'Roundabout',
                 'Basketball_Court', 'Football_Field', 'Baseball_Field']

Single_CLASSES = ['object']

LAB1_CLASSES = ['Vehicle']
LAB2_CLASSES = ['Small_vehicle', 'Large_vehicle']
LAB3_CLASSES = ['Car','Bus','Truck']
LAB4_CLASSES = ['Car', 'Bus', 'Truck', "Van"]
def get_classes_by_name(name):
    res = {
        ...
        'SSDD':     SSDD_CLASSES,
        'SSDD+':    SSDD_CLASSES,
        'RS2022':   RS2022_CLASSES,
        'Single':   Single_CLASSES,
        'vehicle1': LAB1_CLASSES,
        'vehicle2': LAB2_CLASSES,
        'vehicle3': LAB3_CLASSES,
        'vehicle4': LAB4_CLASSES,
    }
    assert(name in res)
    return res[name]