...
class MAFPN(nn.Module):
    ...
    def __init__(self,
        ...
        self.Apool = nn.AvgPool2d(kernel_size=7, stride=1, padding=3)
        self.Mpool = nn.MaxPool2d(kernel_size=7, stride=1, padding=3)
        self.init_weights()
    ...
    def execute(self, inputs):
        ...
        for i in range(len(laterals)):
            laterals[i] = laterals[i] + self.Mpool(laterals[i]) - self.Apool(laterals[i])
        # MA module stop
